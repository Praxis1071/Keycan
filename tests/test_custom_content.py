...
import keycan.data.database_compat2  # noqa: F401
...
def test_custom_group_delete_keeps_history_but_hides_content(tmp_path: Path) -> None:
    ...
    try:
        group = db.create_custom_group("Silinecek")
        lesson = db.create_custom_lesson(group, "metin")
