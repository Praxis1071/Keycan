...
TRANSLATIONS = {
    ...
    "Metni kaydet": "Save text",
    "Metni sil": "Delete text",
    "Yerel ilerlemen ve başarıların": "Your local progress and achievements",
    "Seviye": "Level",
    "XP kazandıkça seviye atla ve bir sonraki seviyeye ilerle.": "Earn XP, level up, and progress toward the next level.",
    "Sonraki seviye için": "Until next level",
    "rozet açıldı.": "badges unlocked.",
